...
sealed class _FavoritesEvent {
  const _FavoritesEvent();
}

/// Event to refresh the list of favorites from the database.
final class FavoritesRefreshed extends _FavoritesEvent {
...
final class FavoritesAdded extends _FavoritesEvent {
...
final class FavoritesRemoved extends _FavoritesEvent {
